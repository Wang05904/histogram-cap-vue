...
export async function runFastestHistogram(imageData, options = {}) {
  ...
  return {
    ...
    accuracy,
    selectionReason:
      'Selected from exact benchmark candidates for the current image; dataMode now includes histArray and histTypedArray, while unroll2 and unroll8 remain benchmark-only comparison items.',
    benchmarkSummary: {
